...
satPY Scraper is a modular, protocol based high resolution satellite image scraper which utilizes the Tor network for HTTP/HTTPS web scraping capabilities as well as some FTP support. 

Here is an .gif file created by satellite images scraped by this program from January 26th - January 27th.
