...
class INSAT_3DR(SatelliteCrawler):
    ...
    INSAT_3DR_REGEX = '(L1B_STD|L2B)'
    INSAT_3DR_BASE_URL = 'https://mosdac.gov.in'
    INSAT_3DR_URL = 'https://mosdac.gov.in/data/weather.do?mode=diplay3DRImage'
    ...
    def get_links(self, pw):
        ...
        a_elements = soup.findAll(self.A_ELEMENT, {self.HREF_ATTRIBUTE: re.compile(self.INSAT_3DR_REGEX)})[::2]
        ...
        for a_element in a_elements:
            link = self.INSAT_3DR_BASE_URL + a_element.get(self.HREF_ATTRIBUTE)
