...
class METEOSAT_8(SatelliteCrawler):
    """
    Concrete satellite spider class for METEOSAT-8 which extends the base class, SatelliteCrawler.
    ...
    TIMES_3_ZOOM = '03'
    METEOSAT_8_DIRECTORY = 'METEOSAT-8'
    METEOSAT_8_BASE_FULL_DISK = 'meteosat-8---full_disk'
    METEOSAT_8_URL = 'https://rammb-slider.cira.colostate.edu/data/imagery/'
    ...
    def __init__(self, url, satellite):
        ...
        @param satellite: str - A string containing a representative name for the METEOSAT-8 satellite crawler.
        """
    ...
    def get_links(self, pw):
        """
        Implemented abstract public method which performs METEOSAT-8 specific base page extraction and extraction
        ...
        for type_path, zoom in self.IMAGE_PATHS.items():
            ...
            for r in my_range:
                ...
                if 'band' in type_path:
                    ...
                    links[title] = self.get_url() + date_link + '/' + self.METEOSAT_8_BASE_FULL_DISK + \
    ...
    def _create_img_dir(self, title):
        ...
        @return dir_path: str - A directory string containing the following standard format: 'METEOSAT-8/DATE/HH-MM UTC/TITLE'
        ...
        dir_path = self.METEOSAT_8_DIRECTORY + os.sep + str(today) + os.sep + utctime + os.sep + title
    ...
    def create_satellite_directory(self):
        """
        Creates a high-level directory with the static METEOSAT_8_DIRECTORY string if it does not exist.
        """

        if not os.path.exists(self.METEOSAT_8_DIRECTORY):
            os.makedirs(self.METEOSAT_8_DIRECTORY)